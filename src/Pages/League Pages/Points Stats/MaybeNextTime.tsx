...
const buildMaybeNextTimeWeeklyRows = (allLeagues: LeagueData[]): WeeklyStatRow[] => {
...
const MaybeNextTime: React.FC<RecordComponentProps & { minYears?: number }> = ({ data, minYears = 0 }) => {
  ...
  return (
    <WeeklyPointsStats
      rows={weeklyRows}
      metricLabel="Maybe Next Time"
      emptyMessage={`No Maybe Next Time data found (min years: ${minYears}).`}
